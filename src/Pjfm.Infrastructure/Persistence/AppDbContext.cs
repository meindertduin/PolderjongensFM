...
namespace Pjfm.Infrastructure.Persistence
{
    public class AppDbContext : IdentityDbContext, IAppDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<TopTrack>().Property(x => x.SpotifyTrackId).HasMaxLength(50);
            builder.Entity<TopTrack>().Property(x => x.Title).HasMaxLength(100);
            builder.Entity<TopTrack>().Property(x => x.ApplicationUserId).HasMaxLength(100);
            ...
            builder.Entity<ApplicationUser>().Property(x => x.DisplayName).HasMaxLength(50);
